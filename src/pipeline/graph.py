...
class Grapher:
    ...
    def __init__(self, filename):
        ...
        file_path = "../../data/raw4/box/" + filename + '.csv'
        interim_path = "../../data/interim6/" + filename + '.csv'
        image_path = "../../data/raw4/img/" + filename + '.jpg'
    ...
    def relative_distance(self, export_document_graph=True):
        """
