...
def get_data():
    ...
    training,testing,validating = files[1:28],files[28:],files[0]
    print(training , "tr" , testing , "tes" , validating , "val")
    ...
    for file in all_files:
        ...
        df.loc[df['labels'] == 'date', 'num_labels'] = 1
        # df.loc[df['labels'] == 'sup', 'num_labels'] = 7
        df.loc[df['labels'] == 'to', 'num_labels'] = 2
        df.loc[df['labels'] == 'ph', 'num_labels'] = 3
        df.loc[df['labels'] == 'email', 'num_labels'] = 4
        # df.loc[df['labels'] == 'address', 'num_labels'] = 5
